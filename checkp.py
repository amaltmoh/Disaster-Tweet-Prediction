...
test_f1_log = f1_score(y_test, y_test_log)
print("Testing Accuracy (XGBoost): {:.2f}".format(test_f1_log))
...
test_f1_svm = f1_score(y_test, y_test_svm)
print("Testing Accuracy (XGBoost): {:.2f}".format(test_f1_svm))
...
print("Testing Accuracy (XGBoost): {:.2f}".format(test_f1_rf))
...
test_f1_xgb = f1_score(y_test, y_test_xgb)
print("Testing Accuracy (XGBoost): {:.2f}".format(test_f1_xgb))
...
ens_path=r"C:\Users\ASUS\Desktop\amal\check.pkl"
